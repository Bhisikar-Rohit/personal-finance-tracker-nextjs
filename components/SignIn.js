...
function SignIn() {
  ...
  return (
    <main className='container max-w-2xl px-6 mx-auto'>
        ...
        <div className="flex flex-col overflow-hidden shadow-md shadow-slate-500 bg-slate-5=800 rounded-2xl">

            <div className="h-52">
                <img className="object-cover w-full h-full"
                src="https://i.ytimg.com/vi/9cY7yFF4ylg/maxresdefault.jpg"/> 
            </div>
